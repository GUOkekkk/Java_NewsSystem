...
<h3>新闻列表</h3>
    ...
    <form action="QueryNewsServlet" method="post">
        ...
        <tr>新闻类型：
            <select name="type" >
                新闻类型：<option   value="——请输入新闻类型——">——请输入新闻类型——</option>
            ...
            <input type="button" value="返回查询" class="btn btn-primary" onclick="javascript:window.location.href='GetAllServlet'">
        </tr>
        </div>
    ...
    <tr>姓名：<input type="text" size="10px" name="sname" placeholder="请输入姓名" value="${sname}" class="input-sm"> </tr>--%>
        ...
        <input type="button" value="编辑" onclick="editNews()" class="btn bg-success">
                <input type="button" value="返回首页" onclick="javascript:window.location.href='blogin1.jsp'" class="btn bg-success">
