...
<%--<tr>换行--%>
        ...
        <div id="u&p">
            <div class="row fore-group" >
                ...
                <div class="col-sm-4"><input type="text" name="username" class="form-control input-sm"></div>
                <tr>&nbsp</tr> <tr>&nbsp</tr> <tr>&nbsp</tr>
            </div>
            <div class="row fore-group" >
                <div class="col-sm-4" align="right"><label>密码：</label></div>
                <div class="col-sm-4"><input type="password" name="pwd" class="form-control input-sm"></div>
            </div>
            <tr>&nbsp</tr> <tr>&nbsp</tr> <tr>&nbsp</tr>
        ...
        <tr>
            ...
            <td>
                <a href="visitlogin.jsp" class="btn btn-primary"> 游客登录</a> &nbsp
            </td>
            <td>
