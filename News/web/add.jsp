    ...
    <form action="AddNewsServlet" method="post" onsubmit="return chkall()">
        <table border="1" style="width: 70%;" class="table table-bordered table-hover table-striped ">
            ...
            <tr>
                ...
                <td>
                    <input type="date" name="cdate" style="width: 500px">
                </td>
            </tr>
            <tr>
                <td><span style="color: red;">*</span>新闻正文:</td>
                <td><div class="test test-5" >
                    <div class="scrollbar" > <textarea  type="text" name="content" autofocus="autofocus" id="content" style="resize: none; overflow:visible; width: 500px; height: 150px; display: block; word-break: break-word;" onblur="chkContent()" >
                    </textarea>
                    </div></div>
                    <span style="color: red; position: fixed" id="msg_3" ></span></td>
            </tr>
            <tr>
